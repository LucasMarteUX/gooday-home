    ...
    <header className="sticky top-0 z-40 flex items-center justify-between gap-3 border-b border-white/[0.06] bg-[rgba(21,26,31,0.88)] px-4 py-3 backdrop-blur-2xl">
      ...
      <div className="flex items-center gap-1">
        ...
        <button
          ...
          className="relative grid h-11 w-11 place-items-center rounded-xl text-gd-text-secondary"
        >
        ...
        <button
          ...
          className="ml-1 h-10 w-10 overflow-hidden rounded-full border-[1.5px] border-gd-brand bg-gd-elevated"
        >
